...
namespace SBUERK\TF8TestExtension\Tests\Acceptance\Support\Extension;
...
final class ApplicationEnvironment extends BackendEnvironment
{
    ...
    public function bootstrapTypo3Environment(SuiteEvent $suiteEvent): void
    {
        ...
        $faviconSourcePath = $composerPackageManager->getPackageInfo('backend')->getRealPath()
            . '/Resources/Public/Icons/favicon.ico';
        if (!is_file($faviconTargetPath)) {
            symlink($faviconSourcePath, $faviconTargetPath);
        }
    }
